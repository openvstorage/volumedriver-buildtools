...
CPP_EXPORTED_FLAGS="-D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -DBOOST_SPIRIT_THREADSAFE -DBOOST_DATE_TIME_NO_LIB -DBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG -D_FILE_OFFSET_BITS=64 -I/usr/include/python${PYTHON_VERSION}"
