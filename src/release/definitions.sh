...
CPP_EXPORTED_FLAGS="-DBOOST_LOG_DYN_LINK -DBOOST_SPIRIT_THREADSAFE -DBOOST_DATE_TIME_NO_LIB -DBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG -DNDEBUG -D_FILE_OFFSET_BITS=64 -I/usr/include/python${PYTHON_VERSION}"

C_COMPILER=/usr/bin/gcc-4.9
C_COMPILER_EXTRA_FLAGS="-fPIC -I${PREFIX}/include"
C_COMPILER_OPTIMIZE_FLAGS="-g -O2 -${COMPILER_DEBUG_LEVEL?}"
...
CXX_COMPILER_OPTIMIZE_FLAGS="-g -O2 -DNDEBUG -${COMPILER_DEBUG_LEVEL?}"
