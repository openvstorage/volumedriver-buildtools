...
CPP_EXPORTED_FLAGS="-DBOOST_LOG_DYN_LINK -DBOOST_SPIRIT_THREADSAFE -DBOOST_DATE_TIME_NO_LIB -DBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG -DNDEBUG -D_FILE_OFFSET_BITS=64 -I/usr/include/python2.7"
